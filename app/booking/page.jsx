...
const Booking = () => {
  ...
  // Mock status for demonstration purposes
  const bookingStatus = "Confirmed"; // Change to "Pending" to test the other case
