...
const Services = () => {
  ...
  return (
    <div>
      <Nav />
      <div className="px-20 flex justify-between pt-6">
        <h1 className="font-bold text-3xl text-gray-700">All Services</h1>
        <button
          onClick={handleOpen}
          className="align-middle select-none font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none py-2 px-4 rounded-lg bg-gradient-to-tr from-indigo-400 to-indigo-500 text-white shadow-md shadow-gray-900/10 hover:shadow-md hover:shadow-indigo-200 active:opacity-[0.85] flex items-center gap-3"
        >
          Create New Service
          <MdLibraryAdd />
        </button>
      ...
      <div className="px-20 py-6 grid grid-cols-3 gap-6">
