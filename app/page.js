      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-1/2 py-20 px-10 flex items-center">
          <div className="lg:w-full">
            <p className="text-4xl">Get Your Work done in a</p>
            <h1 className="text-8xl  font-normal  text-[#582FFF] mb-4">
              Professional
            </h1>
            <span className="flex justify-center"><svg width="518" height="60" viewBox="0 0 518 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 className="text-center font-extralight text-6xl">Manner</h3>
            <div className="flex w-full justify-around flex-nowrap items-center gap-2  mt-8">
              <button variant="gradient" size="sm" className="w-[274px] h-[71px] flex justify-center items-center rounded-lg gap-6  bg-gradient-to-r from-[#5D35FF] to-[#301BB1] font-semibold text-white">
                Find a Service <RxDoubleArrowRight />
              </button>
              <button variant="gradient" size="sm" className="w-[274px] h-[71px] rounded-lg gap-6 border-2 border-[#582FFF] text-[#582FFF] font-semibold">
            ...
            <div className="flex w-full justify-around flex-nowrap items-center pt-8 gap-2  mt-2">
              <div className=" flex flex-col items-end justify-center">
                  <img
                    className="  max-w-full  rounded-lg w-[100px]"
                    src="/image/start.png"
                    alt=""
                  />
                <div className="">
                  <h3 className="text-center">4.7</h3>
                  <p>Service Rating</p>
                </div>
              </div>
              <div className="star w-1/2   flex text-center gap-4">
                ...
                <div className="w-full flex items-start justify-center flex-col   ">
                  <div className="mb-2 text-[#582FFF] font-bold text-3xl">2+ Lakhs</div>
