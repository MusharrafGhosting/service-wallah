        ...
        <div className="lg:w-1/2 py-20 px-10 flex items-center">
          <div className="lg:w-full">
            ...
            <div className="flex w-full justify-around flex-nowrap items-center gap-2  mt-8">
              <button variant="gradient" size="sm" className="w-[274px] h-[71px] flex justify-center items-center rounded-lg p-[18px 32px] gap-6  bg-gradient-to-r from-[#5D35FF] to-[#301BB1] font-semibold text-white" fullWidth>
                Find a Service <RxDoubleArrowRight />
              </button>
              <button variant="gradient" size="sm" className="w-[274px] h-[71px] rounded-lg p-[18px 32px] gap-6 border border-2 border-[#582FFF] text-[#582FFF] font-semibold" fullWidth>
