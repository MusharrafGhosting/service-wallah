    ...
    <List className="mt-4 mb-6 p-0 lg:mt-0 lg:mb-0 lg:flex-row lg:p-1 md:gap-4">
      ...
      <div className="flex gap-2 justify-evenly">
        <button
          onClick={handleOpen}
          variant="gradient"
          className="flex gap-2 w-full border border-gray-300 shadow py-2 px-4 rounded-md justify-center items-center"
        >
          Location
          <FaLocationDot
            size={18}
        ...
        <button
          onClick={handleOpen2}
          variant="gradient"
          className="flex gap-2 border border-gray-300 shadow py-2 px-3 rounded-full justify-center items-center"
        >
